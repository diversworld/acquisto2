...
$GLOBALS['TL_DCA']['tl_module']['palettes']['acq_productlist']      = '{title_legend},name,headline,type;{config_legend},acquistoShop_jumpTo,acquistoShop_numberOfItems,perPage,acquistoShop_elementsPerRow,acquistoShop_listTemplate;{list_images:hide},acquistoShop_imageSrc,acquistoShop_imageSize,acquistoShop_imageMargin,acquistoShop_imageFloating;{categorie_image},;{expert_legend:hide},cssID,space';
...
//$GLOBALS['TL_DCA']['tl_module']['palettes']['acquisto_breadcrumb']       = '{title_legend},name,headline,type;{config_legend},acquistoShop_jumpTo;{expert_legend:hide},cssID,space';
...
//$GLOBALS['TL_DCA']['tl_module']['palettes']['acquisto_categories']       = '{title_legend},name,headline,type;{config_legend},acquistoShop_levelOffset,acquistoShop_showLevel,acquistoShop_hardLimit,acquistoShop_jumpTo;[reference:hide},acquistoShop_reference,acquistoShop_referencePage;{expert_legend:hide},cssID,space';
 ...
 */
$GLOBALS['TL_DCA']['tl_module']['fields']['acquistoShop_jumpTo'] = array
(
    'label'                   => &$GLOBALS['TL_LANG']['tl_module']['acquistoShop_jumpTo'],
    'exclude'                 => true,
    'inputType'               => 'pageTree',
...
$GLOBALS['TL_DCA']['tl_module']['fields']['acquistoShop_numberOfItems'] = array
(
    'label'                   => &$GLOBALS['TL_LANG']['tl_module']['acquistoShop_numberOfItems'],
    'default'                 => 0,
    'exclude'                 => true,
    'inputType'               => 'text',
...
$GLOBALS['TL_DCA']['tl_module']['fields']['acquistoShop_imageSize'] = array
(
...
$GLOBALS['TL_DCA']['tl_module']['fields']['acquistoShop_imageMargin'] = array
(
...
$GLOBALS['TL_DCA']['tl_module']['fields']['acquistoShop_imageFloating'] = array
(
...
$GLOBALS['TL_DCA']['tl_module']['fields']['acquistoShop_imageFullsize'] = array
(
    'label'                   => &$GLOBALS['TL_LANG']['tl_module']['acquistoShop_imageFullsize'],
    'exclude'                 => true,
    'inputType'               => 'checkbox',
...
$GLOBALS['TL_DCA']['tl_module']['fields']['acquistoShop_levelOffset'] = array
(
    'label'                   => &$GLOBALS['TL_LANG']['tl_module']['acquistoShop_levelOffset'],
    'default'                 => 0,
    'exclude'                 => true,
    'inputType'               => 'text',
    'eval'                    => array('rgxp'=>'digit', 'mandatory'=>true, 'tl_class'=>'w50'),
...
$GLOBALS['TL_DCA']['tl_module']['fields']['acquistoShop_showLevel'] = array
(
    'label'                   => &$GLOBALS['TL_LANG']['tl_module']['acquistoShop_showLevel'],
    'default'                 => 0,
    'exclude'                 => true,
    'inputType'               => 'text',
    'eval'                    => array('rgxp'=>'digit', 'mandatory'=>true, 'tl_class'=>'w50'),
...
$GLOBALS['TL_DCA']['tl_module']['fields']['acquistoShop_menuTyp'] = array
(
    'label'                   => &$GLOBALS['TL_LANG']['tl_module']['acquistoShop_menuTyp'],
    'default'                 => 0,
    'exclude'                 => true,
    'inputType'               => 'select',
...
$GLOBALS['TL_DCA']['tl_module']['fields']['acquistoShop_imageSrc'] = array
(
    'label'                   => &$GLOBALS['TL_LANG']['tl_module']['acquistoShop_imageSrc'],
    'inputType'               => 'fileTree',
    'search'                  => false,
...
$GLOBALS['TL_DCA']['tl_module']['fields']['acquistoShop_socialFacebook'] = array
(
    'label'                   => &$GLOBALS['TL_LANG']['tl_module']['acquistoShop_socialFacebook'],
    'exclude'                 => true,
    'inputType'               => 'checkbox',
    'eval'                    => array('tl_class'=>'w50'),
...
$GLOBALS['TL_DCA']['tl_module']['fields']['acquistoShop_socialTwitter'] = array
(
    'label'                   => &$GLOBALS['TL_LANG']['tl_module']['acquistoShop_socialTwitter'],
    'exclude'                 => true,
    'inputType'               => 'checkbox',
    'eval'                    => array('tl_class'=>'w50'),
    'sql'                     => "smallint(1) NOT NULL default '0'"
...
$GLOBALS['TL_DCA']['tl_module']['fields']['acquistoShop_hardLimit'] = array
(
	'label'                   => &$GLOBALS['TL_LANG']['tl_module']['acquistoShop_hardLimit'],
	'exclude'                 => true,
	'inputType'               => 'checkbox',
	'eval'                    => array('mandatory'=>false, 'isBoolean'=>true),
	'sql'                     => "smallint(1) NOT NULL default '0'"
...
$GLOBALS['TL_DCA']['tl_module']['fields']['acquistoShop_reference'] = array
(
	'label'                   => &$GLOBALS['TL_LANG']['tl_module']['acquistoShop_reference'],
	'exclude'                 => true,
	'inputType'               => 'checkbox',
	'eval'                    => array('mandatory'=>false, 'isBoolean'=>true),
	'sql'                     => "smallint(1) NOT NULL default '0'"
...
$GLOBALS['TL_DCA']['tl_module']['fields']['acquistoShop_referencePage'] = array
(
	'label'                   => &$GLOBALS['TL_LANG']['tl_module']['acquistoShop_referencePage'],
	'exclude'                 => true,
	'inputType'               => 'categorieTree',
	'foreignKey'              => 'tl_shop_warengruppen.title',
